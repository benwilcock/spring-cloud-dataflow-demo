...
echo "If you get arrors because the apps already exist"
echo "Try 'docker start loan-source loan-processor'"
echo "One running, check the Rabbit console exchanges 'approved' and 'declined' for message activity: http://localhost:15672/#/exchanges"
